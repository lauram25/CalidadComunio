...
import com.ps.comunio.comuniops.mock.EquipoMock;
import com.ps.comunio.comuniops.mock.JugadorMock;
import com.ps.comunio.comuniops.mock.ParticipanteMock;
...
public class FichajesSteps {
    ...
    private ParticipanteMock usuarioPobreLleno;
    private ParticipanteMock usuarioPobreVacio;
    private ParticipanteMock usuarioRicoLleno;
    private ParticipanteMock usuarioRicoVacio;
    private JugadorMock messi;
    private JugadorMock gri;
    private JugadorMock cristiano;
    private JugadorMock fernando;
    ...
    public void que_el_usuario_tiene_dinero_para_comprar_a_Griezmann() throws Exception{
